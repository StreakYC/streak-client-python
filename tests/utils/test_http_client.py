...
from streak_crm.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from streak_crm.core.request_options import RequestOptions
...
@patch("streak_crm.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("streak_crm.core.http_client.asyncio.sleep", new_callable=AsyncMock)
